...
pca_train, pca_test, y_train1, y_test1 = train_test_split(X_pca, Class, test_size=0.2, random_state=42)
tsne_train, tsne_test, y_train, y_test = train_test_split(X_tsne, Class, test_size=0.2, random_state=42)
