...
colunas_csgo_round = csgo_round[['time_left','ct_score','t_score','ct_health','t_health','ct_armor','t_armor']]

#DESEMPENHO
pca = PCA(n_components=2)
X_pca = pca.fit_transform(colunas_csgo_round)
tsne = TSNE(n_components=2)
X_tsne = tsne.fit_transform(colunas_csgo_round)
...
X_train2, X_test2, y_train2, y_test2 = train_test_split(colunas_csgo_round, csgo_round_valor, test_size=0.2, random_state=42)
