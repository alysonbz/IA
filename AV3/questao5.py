...
colunas_trojan= trojan[[' Source Port',' Destination Port',' Protocol',' Flow Duration',' Total Fwd Packets', ' Total Backward Packets']]

#DESEMPENHO
pca = PCA(n_components=2)
X_pca = pca.fit_transform(colunas_trojan)
tsne = TSNE(n_components=2)
X_tsne = tsne.fit_transform(colunas_trojan)
...
X_train2, X_test2, y_train2, y_test2 = train_test_split(colunas_trojan, trojan_valor, test_size=0.2, random_state=42)
