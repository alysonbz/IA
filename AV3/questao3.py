...
# Determinar o número de linhas que serão mantidas (30% das linhas originais)
...
smoking_valor= csgo_round_df['round_winner'].values
...
X_pca_train, X_pca_test, y_train, y_test = train_test_split(X_pca, smoking_valor, test_size=0.2, random_state=42)
X_tsne_train, X_tsne_test, y_train1, y_test1 = train_test_split(X_tsne, smoking_valor, test_size=0.2, random_state=42)
