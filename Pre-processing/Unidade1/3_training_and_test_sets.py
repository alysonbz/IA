...
# Exclua as linhas com valores null da coluna category_desc de
volunteer_new = volunteer_new.dropna(subset=["category_desc"])

# mostre o balanceamento das classes em 'category_desc'
print("balanceamento das classes em 'category_desc\n", volunteer_new['category_desc'].value_counts(),'\n','\n')
...
print("das classes em 'category_desc", y_train.value_counts(),'\n','\n', y_test.value_counts(),'\n','\n')