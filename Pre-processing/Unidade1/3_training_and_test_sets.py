...
volunteer_new= volunteer_new["category_desc"].dropna()
...
X_train, X_test, y_train, y_test = train_test_split(X,y, test_size=y, random_state=42)

# mostre o balanceamento das classes em 'category_desc' novamente
print(y_train['category_desc'].value.counts())
