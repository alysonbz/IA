...
# Create neighbors
neighbors = np.arange(1, 12) #quantidade de vizinhos
train_accuracies = {}
test_accuracies = {}

for neighbor in neighbors: #contando dentro da vizinhança
...
# Add a title
plt.title("Classificação dos vizinhos")

# Plot training accuracies
plt.plot(neighbors, train_accuracies.values(), label="Acurácia do treino")

# Plot test accuracies
plt.plot(neighbors, test_accuracies, label="Acurácia do treino")
