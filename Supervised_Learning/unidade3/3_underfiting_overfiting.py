...
# Add a title
plt.title("Verificando o número de vizinhos")

# Plot training accuracies
plt.plot(neighbors, train_accuracies.values(), label="Treino de acurácia")

# Plot test accuracies
plt.plot(neighbors, test_accuracies.values(), label="Treino de acurácia")
