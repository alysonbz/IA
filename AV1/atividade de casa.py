...
Original file is located at
    https://colab.research.google.com/drive/1GlRSmLnvWAxwOCWTSo1x5xnBwGKVhuO0
"""

import pandas as pd # importei a biblioteca pandas, pois será necessário, ja que será usado um dataset 

df = pd.read_csv("/content/iris (1).data", delimiter=";") # atribui o dataset (coolocando o caminho) a variável 'df' , e usei "reaad_csv" para ler o arquivo.
print(df)

from ast import Try
lista=[]
with open('/content/iris (1).data', 'r') as f:
