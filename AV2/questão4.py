...
# Definir os atributos preditores (X) e o alvo (y).
X = ferrari[['Close']].values  # Atributo mais relevante definido anteriormente
y = ferrari['Adj Close'].values  # Alvo (Adj Close)
...
# Imprimem o score médio R² e o desvio padrão dos scores R².
